  ...
  <q-page>
    ...
    <div>
      <div class="row justify-center">
        <q-card square v-for="part in filteredParts.parts" :key="part.id" class="col-md-2 bg-secondary q-ma-sm"
          style="max-width: 15rem;">
          <q-card-section>
            <img class="fit" :src="part.img" alt="">
    ...
    <div class="row justify-between mont3 q-mt-md select">
      <div class="col-12 col-md-6 column ">
        <div square class="bg-primary q-ma-sm">
          ...
          <div class="q-mb-md">
            <h4 class=" text-secondary text-weight-bold text-italic q-ma-none">PRICE: {{ formatCurrency(
              filteredParts.totalPrice) }}</h4>
          </div>
        </div>
      </div>
